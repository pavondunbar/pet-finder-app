...
function fetchAnimals(e) {
  ...
  (0, _fetchJsonp.default)("http://api.petfinder.com/pet.find?format=json&key=b54ddc2ece3aa0122ae3a3e1cec4fa63&animal=".concat(animal, "&location=").concat(zip, "&callback=callback"), {
